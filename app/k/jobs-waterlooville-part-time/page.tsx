...
export const metadata: Metadata = {
  title: 'jobs waterlooville part time | Job Opportunities & Employment Guide',
  description: 'Find jobs waterlooville part time opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'jobs waterlooville part time, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'jobs waterlooville part time | Job Opportunities & Employment Guide',
    description: 'Find jobs waterlooville part time opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://waterlooville.co/k/jobs-waterlooville-part-time',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function JobswaterloovilleparttimePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# jobs waterlooville part time - Employment Opportunities

Discover exciting career opportunities with jobs waterlooville part time in Waterlooville and surrounding areas.
