...
export const metadata: Metadata = {
  title: 'homes for sale waterlooville | Property Information & Real Estate Guide',
  description: 'Complete property guide for homes for sale waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'homes for sale waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'homes for sale waterlooville | Property Information & Real Estate Guide',
    description: 'Complete property guide for homes for sale waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/homes-for-sale-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function HomesforsalewaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# homes for sale waterlooville - Property Guide

Your comprehensive guide to homes for sale waterlooville in Waterlooville, including market information, property types, and local insights.
