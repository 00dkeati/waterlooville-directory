...
export const metadata: Metadata = {
  title: 'waterlooville estate agents | Property Information & Real Estate Guide',
  description: 'Complete property guide for waterlooville estate agents. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'waterlooville estate agents, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville estate agents | Property Information & Real Estate Guide',
    description: 'Complete property guide for waterlooville estate agents. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-estate-agents',
    type: 'website',
  },
  robots: {
    index: true,
...
# waterlooville estate agents - Property Guide

Your comprehensive guide to waterlooville estate agents in Waterlooville, including market information, property types, and local insights.
