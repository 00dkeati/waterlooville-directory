...
export const metadata: Metadata = {
  title: 'waterlooville property for sale | Property Information & Real Estate Guide',
  description: 'Complete property guide for waterlooville property for sale. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'waterlooville property for sale, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville property for sale | Property Information & Real Estate Guide',
    description: 'Complete property guide for waterlooville property for sale. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-property-for-sale',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillepropertyforsalePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville property for sale - Property Guide

Your comprehensive guide to waterlooville property for sale in Waterlooville, including market information, property types, and local insights.
