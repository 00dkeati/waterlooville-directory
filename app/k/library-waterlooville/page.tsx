...
export const metadata: Metadata = {
  title: 'library waterlooville | Service Information & Community Guide',
  description: 'Complete guide to library waterlooville. Service details, contact information, and local service information for Waterlooville.',
  keywords: 'library waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'library waterlooville | Service Information & Community Guide',
    description: 'Complete guide to library waterlooville. Service details, contact information, and local service information for Waterlooville.',
    url: 'https://waterlooville.co/k/library-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function LibrarywaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# library waterlooville - Service Information

Your comprehensive guide to library waterlooville in Waterlooville, including service details, contact information, and community resources.

## About library waterlooville

library waterlooville provides essential services to the Waterlooville community, ensuring residents have access to important facilities and support.
