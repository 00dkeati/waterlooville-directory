...
export const metadata: Metadata = {
  title: 'waterlooville asda | Store Information & Shopping Guide',
  description: 'Complete guide to waterlooville asda. Store details, opening hours, location, and shopping information for Waterlooville.',
  keywords: 'waterlooville asda, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville asda | Store Information & Shopping Guide',
    description: 'Complete guide to waterlooville asda. Store details, opening hours, location, and shopping information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-asda',
    type: 'website',
  },
  robots: {
    index: true,
...
# waterlooville asda - Shopping Information

Your complete guide to waterlooville asda in Waterlooville, including store details, services, and shopping information.

## About waterlooville asda

waterlooville asda is a popular shopping destination in Waterlooville, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
waterlooville asda is conveniently located in Waterlooville with:
...
waterlooville asda regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at waterlooville asda supports:
- Local employment
