...
export const metadata: Metadata = {
  title: 'rightmove waterlooville | Property Information & Real Estate Guide',
  description: 'Complete property guide for rightmove waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'rightmove waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'rightmove waterlooville | Property Information & Real Estate Guide',
    description: 'Complete property guide for rightmove waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/rightmove-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function RightmovewaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# rightmove waterlooville - Property Guide

Your comprehensive guide to rightmove waterlooville in Waterlooville, including market information, property types, and local insights.
