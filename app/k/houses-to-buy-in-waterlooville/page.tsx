...
export const metadata: Metadata = {
  title: 'houses to buy in waterlooville | Property Information & Real Estate Guide',
  description: 'Complete property guide for houses to buy in waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'houses to buy in waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'houses to buy in waterlooville | Property Information & Real Estate Guide',
    description: 'Complete property guide for houses to buy in waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/houses-to-buy-in-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function HousestobuyinwaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# houses to buy in waterlooville - Property Guide

Your comprehensive guide to houses to buy in waterlooville in Waterlooville, including market information, property types, and local insights.
