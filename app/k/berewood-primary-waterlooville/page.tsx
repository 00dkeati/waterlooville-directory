...
export const metadata: Metadata = {
  title: 'berewood primary waterlooville | Complete Guide to Waterlooville',
  description: 'Everything you need to know about berewood primary waterlooville. Local information, services, and community updates for Waterlooville residents.',
  keywords: 'berewood primary waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'berewood primary waterlooville | Complete Guide to Waterlooville',
    description: 'Everything you need to know about berewood primary waterlooville. Local information, services, and community updates for Waterlooville residents.',
    url: 'https://waterlooville.co/k/berewood-primary-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function BerewoodprimarywaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# berewood primary waterlooville - Complete Guide

Welcome to our comprehensive guide about berewood primary waterlooville. Whether you're a local resident or planning to visit Waterlooville, this page provides all the essential information you need.

## About berewood primary waterlooville

berewood primary waterlooville is an important part of the Waterlooville community. Located in Hampshire, England, Waterlooville offers a perfect blend of traditional charm and modern convenience.
