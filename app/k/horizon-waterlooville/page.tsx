...
export const metadata: Metadata = {
  title: 'horizon waterlooville | Business Information & Contact Details',
  description: 'Find detailed information about horizon waterlooville. Contact details, services, reviews, and location information for this Waterlooville business.',
  keywords: 'horizon waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'horizon waterlooville | Business Information & Contact Details',
    description: 'Find detailed information about horizon waterlooville. Contact details, services, reviews, and location information for this Waterlooville business.',
    url: 'https://waterlooville.co/k/horizon-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function HorizonwaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# horizon waterlooville - Business Information

Discover everything you need to know about horizon waterlooville, a valued business serving the Waterlooville community.

## About horizon waterlooville

horizon waterlooville is an established business in Waterlooville, providing quality services to local residents and visitors. With a commitment to customer satisfaction and community involvement, this business has become an integral part of the local area.

## Services Offered

horizon waterlooville offers a range of services designed to meet the needs of the Waterlooville community:
...
## Why Choose horizon waterlooville?
...
Customers consistently praise horizon waterlooville for:
- Professional service delivery
...
For more information about horizon waterlooville:
...
Choosing horizon waterlooville means supporting the local Waterlooville economy. Local businesses like this one:
