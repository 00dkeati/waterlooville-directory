...
export const metadata: Metadata = {
  title: 'waterlooville wickes | Store Information & Shopping Guide',
  description: 'Complete guide to waterlooville wickes. Store details, opening hours, location, and shopping information for Waterlooville.',
  keywords: 'waterlooville wickes, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville wickes | Store Information & Shopping Guide',
    description: 'Complete guide to waterlooville wickes. Store details, opening hours, location, and shopping information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-wickes',
    type: 'website',
  },
  robots: {
    index: true,
...
# waterlooville wickes - Shopping Information

Your complete guide to waterlooville wickes in Waterlooville, including store details, services, and shopping information.

## About waterlooville wickes

waterlooville wickes is a popular shopping destination in Waterlooville, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
waterlooville wickes is conveniently located in Waterlooville with:
...
waterlooville wickes regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at waterlooville wickes supports:
- Local employment
