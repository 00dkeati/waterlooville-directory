...
export const metadata: Metadata = {
  title: 'jobs waterlooville | Job Opportunities & Employment Guide',
  description: 'Find jobs waterlooville opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'jobs waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'jobs waterlooville | Job Opportunities & Employment Guide',
    description: 'Find jobs waterlooville opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://waterlooville.co/k/jobs-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function JobswaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# jobs waterlooville - Employment Opportunities

Discover exciting career opportunities with jobs waterlooville in Waterlooville and surrounding areas.
