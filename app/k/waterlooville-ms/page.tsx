...
export const metadata: Metadata = {
  title: 'waterlooville m&s | Store Information & Shopping Guide',
  description: 'Complete guide to waterlooville m&s. Store details, opening hours, location, and shopping information for Waterlooville.',
  keywords: 'waterlooville m&s, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville m&s | Store Information & Shopping Guide',
    description: 'Complete guide to waterlooville m&s. Store details, opening hours, location, and shopping information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-ms',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillemsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville m&s - Shopping Information

Your complete guide to waterlooville m&s in Waterlooville, including store details, services, and shopping information.

## About waterlooville m&s

waterlooville m&s is a popular shopping destination in Waterlooville, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
waterlooville m&s is conveniently located in Waterlooville with:
...
waterlooville m&s regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at waterlooville m&s supports:
- Local employment
