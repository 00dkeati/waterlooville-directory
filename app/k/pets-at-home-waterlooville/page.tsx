...
export const metadata: Metadata = {
  title: 'pets at home waterlooville | Store Information & Shopping Guide',
  description: 'Complete guide to pets at home waterlooville. Store details, opening hours, location, and shopping information for Waterlooville.',
  keywords: 'pets at home waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'pets at home waterlooville | Store Information & Shopping Guide',
    description: 'Complete guide to pets at home waterlooville. Store details, opening hours, location, and shopping information for Waterlooville.',
    url: 'https://waterlooville.co/k/pets-at-home-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function PetsathomewaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# pets at home waterlooville - Shopping Information

Your complete guide to pets at home waterlooville in Waterlooville, including store details, services, and shopping information.

## About pets at home waterlooville

pets at home waterlooville is a popular shopping destination in Waterlooville, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
pets at home waterlooville is conveniently located in Waterlooville with:
...
pets at home waterlooville offers:
...
pets at home waterlooville regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at pets at home waterlooville supports:
- Local employment
