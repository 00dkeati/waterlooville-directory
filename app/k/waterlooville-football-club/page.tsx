...
export const metadata: Metadata = {
  title: 'waterlooville football club | Sports Information & Community Guide',
  description: 'Complete guide to waterlooville football club. Fixtures, results, membership, and community sports information for Waterlooville.',
  keywords: 'waterlooville football club, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville football club | Sports Information & Community Guide',
    description: 'Complete guide to waterlooville football club. Fixtures, results, membership, and community sports information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-football-club',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillefootballclubPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville football club - Sports Information

Your complete guide to waterlooville football club, featuring fixtures, results, membership information, and community sports activities.

## About waterlooville football club

waterlooville football club is an integral part of the Waterlooville sports community, providing opportunities for participation, competition, and community engagement.
