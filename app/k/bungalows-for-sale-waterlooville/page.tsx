...
export const metadata: Metadata = {
  title: 'bungalows for sale waterlooville | Property Information & Real Estate Guide',
  description: 'Complete property guide for bungalows for sale waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'bungalows for sale waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'bungalows for sale waterlooville | Property Information & Real Estate Guide',
    description: 'Complete property guide for bungalows for sale waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/bungalows-for-sale-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function BungalowsforsalewaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# bungalows for sale waterlooville - Property Guide

Your comprehensive guide to bungalows for sale waterlooville in Waterlooville, including market information, property types, and local insights.
