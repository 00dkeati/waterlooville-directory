...
export const metadata: Metadata = {
  title: 'jobs waterlooville hampshire | Job Opportunities & Employment Guide',
  description: 'Find jobs waterlooville hampshire opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'jobs waterlooville hampshire, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'jobs waterlooville hampshire | Job Opportunities & Employment Guide',
    description: 'Find jobs waterlooville hampshire opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://waterlooville.co/k/jobs-waterlooville-hampshire',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function JobswaterloovillehampshirePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# jobs waterlooville hampshire - Employment Opportunities

Discover exciting career opportunities with jobs waterlooville hampshire in Waterlooville and surrounding areas.
