...
export const metadata: Metadata = {
  title: 'met office waterlooville | Weather Forecast & Local Conditions',
  description: 'Get the latest weather information for met office waterlooville. Current conditions, forecasts, and weather updates for Waterlooville area.',
  keywords: 'met office waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'met office waterlooville | Weather Forecast & Local Conditions',
    description: 'Get the latest weather information for met office waterlooville. Current conditions, forecasts, and weather updates for Waterlooville area.',
    url: 'https://waterlooville.co/k/met-office-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function MetofficewaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# met office waterlooville - Weather Information
