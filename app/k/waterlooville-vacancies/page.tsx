...
export const metadata: Metadata = {
  title: 'waterlooville vacancies | Job Opportunities & Employment Guide',
  description: 'Find waterlooville vacancies opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'waterlooville vacancies, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville vacancies | Job Opportunities & Employment Guide',
    description: 'Find waterlooville vacancies opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://waterlooville.co/k/waterlooville-vacancies',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillevacanciesPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville vacancies - Employment Opportunities

Discover exciting career opportunities with waterlooville vacancies in Waterlooville and surrounding areas.
