...
export const metadata: Metadata = {
  title: 'estate agents waterlooville | Property Information & Real Estate Guide',
  description: 'Complete property guide for estate agents waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'estate agents waterlooville, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'estate agents waterlooville | Property Information & Real Estate Guide',
    description: 'Complete property guide for estate agents waterlooville. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/estate-agents-waterlooville',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function EstateagentswaterloovillePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# estate agents waterlooville - Property Guide

Your comprehensive guide to estate agents waterlooville in Waterlooville, including market information, property types, and local insights.
