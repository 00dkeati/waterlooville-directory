...
export const metadata: Metadata = {
  title: 'waterlooville jobs | Job Opportunities & Employment Guide',
  description: 'Find waterlooville jobs opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'waterlooville jobs, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville jobs | Job Opportunities & Employment Guide',
    description: 'Find waterlooville jobs opportunities in Waterlooville. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://waterlooville.co/k/waterlooville-jobs',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillejobsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville jobs - Employment Opportunities

Discover exciting career opportunities with waterlooville jobs in Waterlooville and surrounding areas.
