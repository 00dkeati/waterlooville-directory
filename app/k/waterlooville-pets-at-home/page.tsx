...
export const metadata: Metadata = {
  title: 'waterlooville pets at home | Store Information & Shopping Guide',
  description: 'Complete guide to waterlooville pets at home. Store details, opening hours, location, and shopping information for Waterlooville.',
  keywords: 'waterlooville pets at home, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville pets at home | Store Information & Shopping Guide',
    description: 'Complete guide to waterlooville pets at home. Store details, opening hours, location, and shopping information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-pets-at-home',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillepetsathomePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville pets at home - Shopping Information

Your complete guide to waterlooville pets at home in Waterlooville, including store details, services, and shopping information.

## About waterlooville pets at home

waterlooville pets at home is a popular shopping destination in Waterlooville, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
waterlooville pets at home is conveniently located in Waterlooville with:
...
waterlooville pets at home offers:
...
waterlooville pets at home regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at waterlooville pets at home supports:
- Local employment
