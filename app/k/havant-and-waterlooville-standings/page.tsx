...
export const metadata: Metadata = {
  title: 'havant and waterlooville standings | Sports Information & Community Guide',
  description: 'Complete guide to havant and waterlooville standings. Fixtures, results, membership, and community sports information for Waterlooville.',
  keywords: 'havant and waterlooville standings, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'havant and waterlooville standings | Sports Information & Community Guide',
    description: 'Complete guide to havant and waterlooville standings. Fixtures, results, membership, and community sports information for Waterlooville.',
    url: 'https://waterlooville.co/k/havant-and-waterlooville-standings',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function HavantandwaterloovillestandingsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# havant and waterlooville standings - Sports Information

Your complete guide to havant and waterlooville standings, featuring fixtures, results, membership information, and community sports activities.

## About havant and waterlooville standings

havant and waterlooville standings is an integral part of the Waterlooville sports community, providing opportunities for participation, competition, and community engagement.
