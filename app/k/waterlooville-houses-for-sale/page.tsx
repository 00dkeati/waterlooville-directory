...
export const metadata: Metadata = {
  title: 'waterlooville houses for sale | Property Information & Real Estate Guide',
  description: 'Complete property guide for waterlooville houses for sale. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
  keywords: 'waterlooville houses for sale, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville houses for sale | Property Information & Real Estate Guide',
    description: 'Complete property guide for waterlooville houses for sale. Find homes, get market insights, and connect with local estate agents in Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-houses-for-sale',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillehousesforsalePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville houses for sale - Property Guide

Your comprehensive guide to waterlooville houses for sale in Waterlooville, including market information, property types, and local insights.
