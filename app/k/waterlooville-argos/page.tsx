...
export const metadata: Metadata = {
  title: 'waterlooville argos | Store Information & Shopping Guide',
  description: 'Complete guide to waterlooville argos. Store details, opening hours, location, and shopping information for Waterlooville.',
  keywords: 'waterlooville argos, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville argos | Store Information & Shopping Guide',
    description: 'Complete guide to waterlooville argos. Store details, opening hours, location, and shopping information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-argos',
    type: 'website',
  },
  robots: {
    index: true,
...
# waterlooville argos - Shopping Information

Your complete guide to waterlooville argos in Waterlooville, including store details, services, and shopping information.

## About waterlooville argos

waterlooville argos is a popular shopping destination in Waterlooville, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
waterlooville argos is conveniently located in Waterlooville with:
...
waterlooville argos regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at waterlooville argos supports:
- Local employment
