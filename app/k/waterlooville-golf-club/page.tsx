...
export const metadata: Metadata = {
  title: 'waterlooville golf club | Sports Information & Community Guide',
  description: 'Complete guide to waterlooville golf club. Fixtures, results, membership, and community sports information for Waterlooville.',
  keywords: 'waterlooville golf club, waterlooville, hampshire, local information, community',
  openGraph: {
    title: 'waterlooville golf club | Sports Information & Community Guide',
    description: 'Complete guide to waterlooville golf club. Fixtures, results, membership, and community sports information for Waterlooville.',
    url: 'https://waterlooville.co/k/waterlooville-golf-club',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function WaterloovillegolfclubPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# waterlooville golf club - Sports Information

Your complete guide to waterlooville golf club, featuring fixtures, results, membership information, and community sports activities.

## About waterlooville golf club

waterlooville golf club is an integral part of the Waterlooville sports community, providing opportunities for participation, competition, and community engagement.
